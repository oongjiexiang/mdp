...
class STM:
    ...
    def write_to_STM(self, message):
        try:
            ...
            print(Fore.LIGHTCYAN_EX + 'In STM: write to STM method: before Transmitted to STM:')
            print(Fore.LIGHTCYAN_EX + '\t %s' % message)
            self.STM_connection.write(message)
            print(Fore.LIGHTCYAN_EX + 'In STM: write to STM method: after Transmitted to STM')
